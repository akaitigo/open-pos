 ...
 * inventory-service の全エンティティが organizationFilter を持つことを検証する。
 *
 * 対象外:
 * - ProcessedEventEntity: 冪等性管理用インフラテーブル（テナント横断）
 */
    ...
    fun `organizationId フィールドが全テナントエンティティに存在する`() {
        val tenantEntities =
            listOf(
                ...
                StockMovementEntity::class.java,
                StockTransferEntity::class.java,
                StockLotEntity::class.java,
                StocktakeEntity::class.java,
                StocktakeItemEntity::class.java,
                PurchaseOrderEntity::class.java,
                PurchaseOrderItemEntity::class.java,
                SupplierEntity::class.java,
            )
