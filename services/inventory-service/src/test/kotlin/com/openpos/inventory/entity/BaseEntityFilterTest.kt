 ...
 */
@Entity
@Table(name = "test_inventory_entity")
class TestInventoryEntity : BaseEntity() {
    var name: String = ""
}
...
class BaseEntityFilterTest {
    ...
    fun `BaseEntity has organizationId field`() {
        val entity = TestInventoryEntity()
        entity.organizationId = UUID.randomUUID()
        entity.name = "test-inventory"
    ...
    fun `organizationFilter filters entities by organizationId`() {
        ...
        val entityA =
            TestInventoryEntity().apply {
                organizationId = orgA
                name = "org-a-inventory"
            }
        val entityB =
            TestInventoryEntity().apply {
                organizationId = orgB
                name = "org-b-inventory"
            }
        ...
        val results =
            entityManager
                .createQuery("SELECT e FROM TestInventoryEntity e", TestInventoryEntity::class.java)
                .resultList
