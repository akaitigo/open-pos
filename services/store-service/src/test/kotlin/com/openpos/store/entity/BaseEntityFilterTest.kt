 ...
 */
@Entity
@Table(name = "test_store_entity")
class TestStoreEntity : BaseEntity() {
    var name: String = ""
}
...
class BaseEntityFilterTest {
    ...
    fun `organizationFilter filters entities by organizationId`() {
        ...
        val results =
            entityManager
                .createQuery("SELECT e FROM TestStoreEntity e", TestStoreEntity::class.java)
                .resultList
