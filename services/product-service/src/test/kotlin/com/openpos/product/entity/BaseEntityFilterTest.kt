 ...
 */
@Entity
@Table(name = "test_product_entity")
class TestProductEntity : BaseEntity() {
    var name: String = ""
}
...
class BaseEntityFilterTest {
    ...
    fun `organizationFilter filters entities by organizationId`() {
        ...
        val results =
            entityManager
                .createQuery("SELECT e FROM TestProductEntity e", TestProductEntity::class.java)
                .resultList
